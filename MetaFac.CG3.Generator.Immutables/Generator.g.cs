...
Emit("");
Emit("namespace T_Namespace_.Immutables");
Emit("{");
    using (Ignored()) {
...
Emit("");
    ...
    using (NewScope(cs)) {
Emit("    public partial class T_ClassName_ : IT_ClassName_, IEquatable<T_ClassName_>, IBuilder<T_ClassName_, T_ClassName_.Builder>");
Emit("    {");
...
Emit("        public T_ModelType_? T_UnaryModelFieldName_ { get; }");
Emit("        IT_ModelType_? IT_ClassName_.T_UnaryModelFieldName_ => T_UnaryModelFieldName_;");
            break; case FieldKind.ArrayModel:
Emit("        public ImmutableList<T_ModelType_?>? T_ArrayModelFieldName_ { get; }");
Emit("        IEnumerable<IT_ModelType_?>? IT_ClassName_.T_ArrayModelFieldName_ => T_ArrayModelFieldName_ is null");
Emit("            ? (IEnumerable<IT_ModelType_?>?)null");
Emit("            : T_ArrayModelFieldName_;");
            break; case FieldKind.IndexModel:
Emit("        public ImmutableDictionary<T_IndexType_, T_ModelType_?>? T_IndexModelFieldName_ { get; }");
...
Emit("        public T_ExternalOtherType_? T_UnaryMaybeFieldName_ { get; }");
Emit("        T_ExternalOtherType_? IT_ClassName_.T_UnaryMaybeFieldName_ => T_UnaryMaybeFieldName_;");
            break; case FieldKind.ArrayMaybe:
Emit("        public ImmutableList<T_ExternalOtherType_?>? T_ArrayMaybeFieldName_ { get; }");
Emit("        IEnumerable<T_ExternalOtherType_?>? IT_ClassName_.T_ArrayMaybeFieldName_ => T_ArrayMaybeFieldName_ is null");
Emit("            ? (IEnumerable<T_ExternalOtherType_?>?)null");
Emit("            : T_ArrayMaybeFieldName_;");
            break; case FieldKind.IndexMaybe:
Emit("        public ImmutableDictionary<T_IndexType_, T_ExternalOtherType_?>? T_IndexMaybeFieldName_ { get; }");
...
Emit("        public T_ExternalOtherType_ T_UnaryOtherFieldName_ { get; }");
Emit("        T_ExternalOtherType_ IT_ClassName_.T_UnaryOtherFieldName_ => T_UnaryOtherFieldName_;");
            break; case FieldKind.ArrayOther:
Emit("        public ImmutableList<T_ExternalOtherType_>? T_ArrayOtherFieldName_ { get; }");
Emit("        IEnumerable<T_ExternalOtherType_>? IT_ClassName_.T_ArrayOtherFieldName_ => T_ArrayOtherFieldName_ is null");
Emit("            ? (IEnumerable<T_ExternalOtherType_>?)null");
Emit("            : T_ArrayOtherFieldName_;");
            break; case FieldKind.IndexOther:
Emit("        public ImmutableDictionary<T_IndexType_, T_ExternalOtherType_>? T_IndexOtherFieldName_ { get; }");
...
Emit("        public Octets? T_UnaryBufferFieldName_ { get; }");
Emit("        Octets? IT_ClassName_.T_UnaryBufferFieldName_ => T_UnaryBufferFieldName_;");
            break; case FieldKind.ArrayBuffer:
Emit("        public ImmutableList<Octets?>? T_ArrayBufferFieldName_ { get; }");
Emit("        IEnumerable<Octets?>? IT_ClassName_.T_ArrayBufferFieldName_ => T_ArrayBufferFieldName_ is null");
Emit("            ? (IEnumerable<Octets?>?)null");
Emit("            : T_ArrayBufferFieldName_;");
            break; case FieldKind.IndexBuffer:
Emit("        public ImmutableDictionary<T_IndexType_, Octets?>? T_IndexBufferFieldName_ { get; }");
...
Emit("        public String? T_UnaryStringFieldName_ { get; }");
Emit("        String? IT_ClassName_.T_UnaryStringFieldName_ => T_UnaryStringFieldName_;");
            break; case FieldKind.ArrayString:
Emit("        public ImmutableList<String?>? T_ArrayStringFieldName_ { get; }");
Emit("        IEnumerable<String?>? IT_ClassName_.T_ArrayStringFieldName_ => T_ArrayStringFieldName_ is null");
Emit("            ? (IEnumerable<String?>?)null");
Emit("            : T_ArrayStringFieldName_;");
            break; case FieldKind.IndexString:
Emit("        public ImmutableDictionary<T_IndexType_, String?>? T_IndexStringFieldName_ { get; }");
...
Emit("        }");
Emit("");
Emit("        public Builder ToBuilder()");
Emit("        {");
Emit("            return new Builder(this);");
Emit("        }");
Emit("");
Emit("        internal T_ClassName_(Builder source)");
Emit("        {");
            foreach (var fs in cs.Iterators["Fields"].Iterations) {
              using (NewScope(fs)) {
                var fieldInfo = new FieldInfo(fs, _engine.Current);
...
Emit("        }");
Emit("");
Emit("        public class Builder : IBuild<T_ClassName_>");
Emit("        {");
            foreach (var fs in cs.Iterators["Fields"].Iterations) {
              using (NewScope(fs)) {
                var fieldInfo = new FieldInfo(fs, _engine.Current);
...
Emit("            public T_ModelType_? T_UnaryModelFieldName_ { get; set; }");
                break; case FieldKind.ArrayModel:
Emit("            public ImmutableList<T_ModelType_?>? T_ArrayModelFieldName_ { get; set; }");
                break; case FieldKind.IndexModel:
Emit("            public ImmutableDictionary<T_IndexType_, T_ModelType_?>? T_IndexModelFieldName_ { get; set; }");
                break; case FieldKind.UnaryMaybe:
Emit("            public T_ExternalOtherType_? T_UnaryMaybeFieldName_ { get; set; }");
                break; case FieldKind.ArrayMaybe:
Emit("            public ImmutableList<T_ExternalOtherType_?>? T_ArrayMaybeFieldName_ { get; set; }");
                break; case FieldKind.IndexMaybe:
Emit("            public ImmutableDictionary<T_IndexType_, T_ExternalOtherType_?>? T_IndexMaybeFieldName_ { get; set; }");
                break; case FieldKind.UnaryOther:
Emit("            public T_ExternalOtherType_ T_UnaryOtherFieldName_ { get; set; }");
                break; case FieldKind.ArrayOther:
Emit("            public ImmutableList<T_ExternalOtherType_>? T_ArrayOtherFieldName_ { get; set; }");
                break; case FieldKind.IndexOther:
Emit("            public ImmutableDictionary<T_IndexType_, T_ExternalOtherType_>? T_IndexOtherFieldName_ { get; set; }");
                break; case FieldKind.UnaryBuffer:
Emit("            public Octets? T_UnaryBufferFieldName_ { get; set; }");
                break; case FieldKind.ArrayBuffer:
Emit("            public ImmutableList<Octets?>? T_ArrayBufferFieldName_ { get; set; }");
                break; case FieldKind.IndexBuffer:
Emit("            public ImmutableDictionary<T_IndexType_, Octets?>? T_IndexBufferFieldName_ { get; set; }");
                break; case FieldKind.UnaryString:
Emit("            public String? T_UnaryStringFieldName_ { get; set; }");
                break; case FieldKind.ArrayString:
Emit("            public ImmutableList<String?>? T_ArrayStringFieldName_ { get; set; }");
                break; case FieldKind.IndexString:
Emit("            public ImmutableDictionary<T_IndexType_, String?>? T_IndexStringFieldName_ { get; set; }");
                break; default: break;
            }
            }}
Emit("");
Emit("            public Builder() { }");
Emit("            internal Builder(T_ClassName_ source)");
Emit("            {");
                foreach (var fs in cs.Iterators["Fields"].Iterations) {
                  using (NewScope(fs)) {
                    var fieldInfo = new FieldInfo(fs, _engine.Current);
...
Emit("            }");
Emit("");
Emit("            public T_ClassName_ Build()");
Emit("            {");
Emit("                return new T_ClassName_(this);");
Emit("            }");
Emit("        }");
Emit("");
Emit("    }");
