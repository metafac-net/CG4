    ...
    public class ValidationError
    {
        ...
        public string Message
        {
            get
            {
                ...
                {
                    ValidationErrorCode.MissingEntityTag => $"{ModelName}.{ModelEntityDef?.Name}: Class tag is missing",
                    ValidationErrorCode.InvalidEntityTag => $"{ModelName}.{ModelEntityDef?.Name}: Class tag ({ModelEntityDef?.Tag}) is invalid",
                    ValidationErrorCode.DuplicateEntityTag => $"{ModelName}.{ModelEntityDef?.Name}: Class tag ({ModelEntityDef?.Tag}) is same as class: {OtherEntityDef?.Name}",
                    ...
                    ValidationErrorCode.RedefinedEntityTag => $"{ModelName}.{ModelEntityDef.Name}: Class tag ({ModelEntityDef.Tag}) redefined by: {OtherEntityDef}",
