...
Emit("        T_ExternalOtherType_? IT_EntityName_.T_UnaryMaybeFieldName_ => T_UnaryMaybeFieldName_;");
                        break;
                    case FieldKind.ArrayMaybe:
Emit("        public ImmutableList<T_ExternalOtherType_?>? T_ArrayMaybeFieldName_ { get; init; }");
Emit("        IReadOnlyList<T_ExternalOtherType_?>? IT_EntityName_.T_ArrayMaybeFieldName_ => T_ArrayMaybeFieldName_;");
                        break;
...
Emit("        IReadOnlyDictionary<T_IndexType_, T_ExternalOtherType_?>? IT_EntityName_.T_IndexMaybeFieldName_ => T_IndexMaybeFieldName_;");
                        break;
...
Emit("        ReadOnlyMemory<byte> IT_EntityName_.T_UnaryBufferFieldName_ => T_UnaryBufferFieldName_;");
                        break;
                    case FieldKind.ArrayBuffer:
Emit("        public ImmutableList<ReadOnlyMemory<byte>>? T_ArrayBufferFieldName_ { get; init; }");
Emit("        IReadOnlyList<ReadOnlyMemory<byte>>? IT_EntityName_.T_ArrayBufferFieldName_ => T_ArrayBufferFieldName_ is null");
Emit("            ? null");
...
Emit("        IReadOnlyDictionary<T_IndexType_, ReadOnlyMemory<byte>>? IT_EntityName_.T_IndexBufferFieldName_ => T_IndexBufferFieldName_ is null");
Emit("            ? null");
...
using (Ignored())
{
Emit("    public record T_SuperEntityName_ : T_EntityName_, IT_SuperEntityName_");
Emit("    {");
Emit("        public T_SuperEntityName_() { }");
Emit("        public T_SuperEntityName_(T_SuperEntityName_? source) : base(source) { }");
Emit("        public T_SuperEntityName_(IT_SuperEntityName_? source) : base(source) { }");
Emit("        public virtual bool Equals(T_SuperEntityName_? other) => true;");
Emit("        public override int GetHashCode() => 0;");
Emit("    }");
}
Emit("");
