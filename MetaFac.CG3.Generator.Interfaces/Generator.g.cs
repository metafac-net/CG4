...
namespace MetaCode.TS3.Generator.Interfaces
{
...
Emit("        IEnumerable<IT_ModelType_?>? T_ArrayModelFieldName_ { get; }");
            break; case FieldKind.IndexModel:
Emit("        IEnumerable<KeyValuePair<T_IndexType_, IT_ModelType_?>>? T_IndexModelFieldName_ { get; }");
            break; case FieldKind.UnaryMaybe:
Emit("        T_ExternalOtherType_? T_UnaryMaybeFieldName_ { get; }");
            break; case FieldKind.ArrayMaybe:
Emit("        IEnumerable<T_ExternalOtherType_?>? T_ArrayMaybeFieldName_ { get; }");
            break; case FieldKind.IndexMaybe:
Emit("        IEnumerable<KeyValuePair<T_IndexType_, T_ExternalOtherType_?>>? T_IndexMaybeFieldName_ { get; }");
            break; case FieldKind.UnaryOther:
Emit("        T_ExternalOtherType_ T_UnaryOtherFieldName_ { get; }");
            break; case FieldKind.ArrayOther:
Emit("        IEnumerable<T_ExternalOtherType_>? T_ArrayOtherFieldName_ { get; }");
            break; case FieldKind.IndexOther:
Emit("        IEnumerable<KeyValuePair<T_IndexType_, T_ExternalOtherType_>>? T_IndexOtherFieldName_ { get; }");
            break; case FieldKind.UnaryBuffer:
Emit("        Octets? T_UnaryBufferFieldName_ { get; }");
            break; case FieldKind.ArrayBuffer:
Emit("        IEnumerable<Octets?>? T_ArrayBufferFieldName_ { get; }");
            break; case FieldKind.IndexBuffer:
Emit("        IEnumerable<KeyValuePair<T_IndexType_, Octets?>>? T_IndexBufferFieldName_ { get; }");
            break; case FieldKind.UnaryString:
Emit("        String? T_UnaryStringFieldName_ { get; }");
            break; case FieldKind.ArrayString:
Emit("        IEnumerable<String?>? T_ArrayStringFieldName_ { get; }");
            break; case FieldKind.IndexString:
Emit("        IEnumerable<KeyValuePair<T_IndexType_, String?>>? T_IndexStringFieldName_ { get; }");
            break; default: break;
        }
        }}
Emit("    }");
