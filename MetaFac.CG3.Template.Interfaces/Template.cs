...
namespace T_Namespace_.Interfaces
{
    ...
    public partial interface IT_ClassName_
    {
        ...
        IEnumerable<IT_ModelType_?>? T_ArrayModelFieldName_ { get; }
        //>>    break; case FieldKind.IndexModel:
        IEnumerable<KeyValuePair<T_IndexType_, IT_ModelType_?>>? T_IndexModelFieldName_ { get; }
        //>>    break; case FieldKind.UnaryMaybe:
        T_ExternalOtherType_? T_UnaryMaybeFieldName_ { get; }
        //>>    break; case FieldKind.ArrayMaybe:
        IEnumerable<T_ExternalOtherType_?>? T_ArrayMaybeFieldName_ { get; }
        //>>    break; case FieldKind.IndexMaybe:
        IEnumerable<KeyValuePair<T_IndexType_, T_ExternalOtherType_?>>? T_IndexMaybeFieldName_ { get; }
        //>>    break; case FieldKind.UnaryOther:
        T_ExternalOtherType_ T_UnaryOtherFieldName_ { get; }
        //>>    break; case FieldKind.ArrayOther:
        IEnumerable<T_ExternalOtherType_>? T_ArrayOtherFieldName_ { get; }
        //>>    break; case FieldKind.IndexOther:
        IEnumerable<KeyValuePair<T_IndexType_, T_ExternalOtherType_>>? T_IndexOtherFieldName_ { get; }
        //>>    break; case FieldKind.UnaryBuffer:
        Octets? T_UnaryBufferFieldName_ { get; }
        //>>    break; case FieldKind.ArrayBuffer:
        IEnumerable<Octets?>? T_ArrayBufferFieldName_ { get; }
        //>>    break; case FieldKind.IndexBuffer:
        IEnumerable<KeyValuePair<T_IndexType_, Octets?>>? T_IndexBufferFieldName_ { get; }
        //>>    break; case FieldKind.UnaryString:
        String? T_UnaryStringFieldName_ { get; }
        //>>    break; case FieldKind.ArrayString:
        IEnumerable<String?>? T_ArrayStringFieldName_ { get; }
        //>>    break; case FieldKind.IndexString:
        IEnumerable<KeyValuePair<T_IndexType_, String?>>? T_IndexStringFieldName_ { get; }
        //>>    break; default: break;
        //>>}
        //>>}}
    }
