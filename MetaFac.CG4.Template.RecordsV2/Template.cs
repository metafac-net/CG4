...
//>>                    case FieldKind.UnaryBuffer:
        ...
        ReadOnlyMemory<byte> IT_EntityName_.T_UnaryBufferFieldName_ => T_UnaryBufferFieldName_;
//>>                        break;
//>>                    case FieldKind.ArrayBuffer:
        public ImmutableList<ReadOnlyMemory<byte>>? T_ArrayBufferFieldName_ { get; init; }
        IReadOnlyList<ReadOnlyMemory<byte>>? IT_EntityName_.T_ArrayBufferFieldName_ => T_ArrayBufferFieldName_ is null
            ? null
...
//>>                    case FieldKind.IndexBuffer:
        ...
        IReadOnlyDictionary<T_IndexType_, ReadOnlyMemory<byte>>? IT_EntityName_.T_IndexBufferFieldName_ => T_IndexBufferFieldName_ is null
            ? null
...
//>>using (Ignored())
//>>{
    public record T_SuperEntityName_ : T_EntityName_, IT_SuperEntityName_
    {
