...
namespace T_Namespace_.ClassesV2
{
    ...
    public partial class T_EntityName_ : T_ParentName_, IT_EntityName_, IEquatable<T_EntityName_>
    {
        ...
        ReadOnlyMemory<byte> IT_EntityName_.T_UnaryBufferFieldName_ => field_T_UnaryBufferFieldName_;
        ...
        IReadOnlyList<ReadOnlyMemory<byte>>? IT_EntityName_.T_ArrayBufferFieldName_ => field_T_ArrayBufferFieldName_;
        ...
        IReadOnlyDictionary<T_IndexType_, ReadOnlyMemory<byte>>? IT_EntityName_.T_IndexBufferFieldName_ => field_T_IndexBufferFieldName_;
    ...
    //>>using (Ignored())
    //>>{
    public class T_SuperEntityName_ : T_EntityName_, IT_SuperEntityName_
    {
        public T_SuperEntityName_() { }
        public T_SuperEntityName_(T_SuperEntityName_? source) : base(source) { }
        public T_SuperEntityName_(IT_SuperEntityName_? source) : base(source) { }
        public virtual bool Equals(T_SuperEntityName_? other) => true;
        public override int GetHashCode() => 0;
    }
    //>>}
}
