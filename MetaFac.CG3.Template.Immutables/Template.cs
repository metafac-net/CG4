...
namespace T_Namespace_.Immutables
{
    //>>using (Ignored()) {
    ...
    //>>using (NewScope(cs)) {
    public partial class T_ClassName_ : IT_ClassName_, IEquatable<T_ClassName_>, IBuilder<T_ClassName_, T_ClassName_.Builder>
    {
...
#pragma warning restore 109
        ...
        public T_ModelType_? T_UnaryModelFieldName_ { get; }
        IT_ModelType_? IT_ClassName_.T_UnaryModelFieldName_ => T_UnaryModelFieldName_;
        //>>    break; case FieldKind.ArrayModel:
        public ImmutableList<T_ModelType_?>? T_ArrayModelFieldName_ { get; }
        IEnumerable<IT_ModelType_?>? IT_ClassName_.T_ArrayModelFieldName_ => T_ArrayModelFieldName_ is null
            ? (IEnumerable<IT_ModelType_?>?)null
            : T_ArrayModelFieldName_;
        //>>    break; case FieldKind.IndexModel:
        public ImmutableDictionary<T_IndexType_, T_ModelType_?>? T_IndexModelFieldName_ { get; }
        ...
        public T_ExternalOtherType_? T_UnaryMaybeFieldName_ { get; }
        T_ExternalOtherType_? IT_ClassName_.T_UnaryMaybeFieldName_ => T_UnaryMaybeFieldName_;
        //>>    break; case FieldKind.ArrayMaybe:
        public ImmutableList<T_ExternalOtherType_?>? T_ArrayMaybeFieldName_ { get; }
        IEnumerable<T_ExternalOtherType_?>? IT_ClassName_.T_ArrayMaybeFieldName_ => T_ArrayMaybeFieldName_ is null
            ? (IEnumerable<T_ExternalOtherType_?>?)null
            : T_ArrayMaybeFieldName_;
        //>>    break; case FieldKind.IndexMaybe:
        public ImmutableDictionary<T_IndexType_, T_ExternalOtherType_?>? T_IndexMaybeFieldName_ { get; }
        ...
        public T_ExternalOtherType_ T_UnaryOtherFieldName_ { get; }
        T_ExternalOtherType_ IT_ClassName_.T_UnaryOtherFieldName_ => T_UnaryOtherFieldName_;
        //>>    break; case FieldKind.ArrayOther:
        public ImmutableList<T_ExternalOtherType_>? T_ArrayOtherFieldName_ { get; }
        IEnumerable<T_ExternalOtherType_>? IT_ClassName_.T_ArrayOtherFieldName_ => T_ArrayOtherFieldName_ is null
            ? (IEnumerable<T_ExternalOtherType_>?)null
            : T_ArrayOtherFieldName_;
        //>>    break; case FieldKind.IndexOther:
        public ImmutableDictionary<T_IndexType_, T_ExternalOtherType_>? T_IndexOtherFieldName_ { get; }
        ...
        public Octets? T_UnaryBufferFieldName_ { get; }
        Octets? IT_ClassName_.T_UnaryBufferFieldName_ => T_UnaryBufferFieldName_;
        //>>    break; case FieldKind.ArrayBuffer:
        public ImmutableList<Octets?>? T_ArrayBufferFieldName_ { get; }
        IEnumerable<Octets?>? IT_ClassName_.T_ArrayBufferFieldName_ => T_ArrayBufferFieldName_ is null
            ? (IEnumerable<Octets?>?)null
            : T_ArrayBufferFieldName_;
        //>>    break; case FieldKind.IndexBuffer:
        public ImmutableDictionary<T_IndexType_, Octets?>? T_IndexBufferFieldName_ { get; }
        ...
        public String? T_UnaryStringFieldName_ { get; }
        String? IT_ClassName_.T_UnaryStringFieldName_ => T_UnaryStringFieldName_;
        //>>    break; case FieldKind.ArrayString:
        public ImmutableList<String?>? T_ArrayStringFieldName_ { get; }
        IEnumerable<String?>? IT_ClassName_.T_ArrayStringFieldName_ => T_ArrayStringFieldName_ is null
            ? (IEnumerable<String?>?)null
            : T_ArrayStringFieldName_;
        //>>    break; case FieldKind.IndexString:
        public ImmutableDictionary<T_IndexType_, String?>? T_IndexStringFieldName_ { get; }
        ...
        internal T_ClassName_(Builder source)
        {
            //>>foreach (var fs in cs.Iterators["Fields"].Iterations) {
            //>>  using (NewScope(fs)) {
            //>>    var fieldInfo = new FieldInfo(fs, _engine.Current);
        ...
        public class Builder : IBuild<T_ClassName_>
        {
            //>>foreach (var fs in cs.Iterators["Fields"].Iterations) {
            //>>  using (NewScope(fs)) {
            //>>    var fieldInfo = new FieldInfo(fs, _engine.Current);
            ...
            //>>    break; case FieldKind.ArrayModel:
            public ImmutableList<T_ModelType_?>? T_ArrayModelFieldName_ { get; set; }
            //>>    break; case FieldKind.IndexModel:
            public ImmutableDictionary<T_IndexType_, T_ModelType_?>? T_IndexModelFieldName_ { get; set; }
            //>>    break; case FieldKind.UnaryMaybe:
            public T_ExternalOtherType_? T_UnaryMaybeFieldName_ { get; set; }
            //>>    break; case FieldKind.ArrayMaybe:
            public ImmutableList<T_ExternalOtherType_?>? T_ArrayMaybeFieldName_ { get; set; }
            //>>    break; case FieldKind.IndexMaybe:
            public ImmutableDictionary<T_IndexType_, T_ExternalOtherType_?>? T_IndexMaybeFieldName_ { get; set; }
            //>>    break; case FieldKind.UnaryOther:
            public T_ExternalOtherType_ T_UnaryOtherFieldName_ { get; set; }
            //>>    break; case FieldKind.ArrayOther:
            public ImmutableList<T_ExternalOtherType_>? T_ArrayOtherFieldName_ { get; set; }
            //>>    break; case FieldKind.IndexOther:
            public ImmutableDictionary<T_IndexType_, T_ExternalOtherType_>? T_IndexOtherFieldName_ { get; set; }
            //>>    break; case FieldKind.UnaryBuffer:
            public Octets? T_UnaryBufferFieldName_ { get; set; }
            //>>    break; case FieldKind.ArrayBuffer:
            public ImmutableList<Octets?>? T_ArrayBufferFieldName_ { get; set; }
            //>>    break; case FieldKind.IndexBuffer:
            public ImmutableDictionary<T_IndexType_, Octets?>? T_IndexBufferFieldName_ { get; set; }
            //>>    break; case FieldKind.UnaryString:
            public String? T_UnaryStringFieldName_ { get; set; }
            //>>    break; case FieldKind.ArrayString:
            public ImmutableList<String?>? T_ArrayStringFieldName_ { get; set; }
            //>>    break; case FieldKind.IndexString:
            public ImmutableDictionary<T_IndexType_, String?>? T_IndexStringFieldName_ { get; set; }
            //>>    break; default: break;
            //>>}
            //>>}}

            public Builder() { }
            internal Builder(T_ClassName_ source)
            {
                //>>foreach (var fs in cs.Iterators["Fields"].Iterations) {
                //>>  using (NewScope(fs)) {
                //>>    var fieldInfo = new FieldInfo(fs, _engine.Current);
            ...
            public T_ClassName_ Build()
            {
                return new T_ClassName_(this);
            }
        }
