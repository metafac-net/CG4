...
Emit("        ReadOnlyMemory<byte> IT_EntityName_.T_UnaryBufferFieldName_ => field_T_UnaryBufferFieldName_;");
...
Emit("        IReadOnlyList<ReadOnlyMemory<byte>>? IT_EntityName_.T_ArrayBufferFieldName_ => field_T_ArrayBufferFieldName_;");
...
Emit("        IReadOnlyDictionary<T_IndexType_, ReadOnlyMemory<byte>>? IT_EntityName_.T_IndexBufferFieldName_ => field_T_IndexBufferFieldName_;");
...
Emit("");
    using (Ignored())
    {
Emit("    public class T_SuperEntityName_ : T_EntityName_, IT_SuperEntityName_");
Emit("    {");
