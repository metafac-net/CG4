...
Emit("            ? null");
Emit("            : new ListFacade<T_ExternalMaybeType_?, T_ConcreteMaybeType_?>(field_T_ArrayMaybeFieldName_, (x) => x);");
...
Emit("            ? null");
Emit("            : new DictionaryFacade<T_IndexType_, T_ExternalMaybeType_?, T_ConcreteMaybeType_?>(field_T_IndexMaybeFieldName_, (x) => x);");
...
Emit("            ? null");
Emit("            : new ListFacade<T_ExternalOtherType_, T_ConcreteOtherType_>(field_T_ArrayOtherFieldName_, (x) => x);");
...
Emit("            ? null");
Emit("            : new DictionaryFacade<T_IndexType_, T_ExternalOtherType_, T_ConcreteOtherType_>(field_T_IndexOtherFieldName_, (x) => x);");
